...
def clicked1(event):
	...
	labInput7.config(text = "Uncommon Skins: "+str(OutfitUC))
	labInput8.config(text = "Rare Skins: "+str(OutfitR))
	labInput8.config(text = "Epic Skins: "+str(OutfitE))
	labInput8.config(text = "Legendary Skins: "+str(OutfitL))
...
def clicked2(event):
	...
	labInput3.config(background = "grey", foreground = "black")
	labInput7.config(text = "Rare Pickaxes: "+str(pickaxesR))
	labInput7.config(text = "Uncommon Pickaxes: "+str(pickaxesUC))
	labInput8.config(text = "Rare Pickaxes: "+str(pickaxesR))
	labInput8.config(text = "Epic Pickaxes: "+str(pickaxesE))
	labInput8.config(text = "Legendary Pickaxes: "+str(pickaxesL))
...
def clicked3(event):
	...
	labInput2.config(background = "grey", foreground = "black")
	labInput1.config(background = "grey", foreground = "black")
	labInput7.config(text = "Rare Gliders: "+str(GlidersR))
	labInput7.config(text = "Uncommon Gliders: "+str(GlidersUC))
	labInput8.config(text = "Rare Gliders: "+str(GlidersR))
	labInput8.config(text = "Epic Gliders: "+str(GlidersE))
	labInput8.config(text = "Legendary Gliders: "+str(GlidersL))
